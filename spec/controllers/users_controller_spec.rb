...
describe UsersController do
  ...
  describe 'validators' do
    context 'validations are disabled' do
      ...
      it 'should pass if required parameter is missing' do
        -> { get :show, id: 5 }.should_not raise_error
      end
    end
    ...
    context 'validations are enabled' do
      ...
      shared_examples 'validates correctly' do
        context 'only presence validations are enabled' do
          ...
          it 'should reply to valid request' do
            -> { get :show, id: 5, session: 'secret_hash' }.should_not raise_error
            assert_response :success
          end

          it 'should fail if required parameter is missing' do
            -> { get :show, id: 5 }.should raise_error(Apipie::ParamMissing, /\bsession\b/)
          end

          it 'should pass if required parameter has wrong type' do
            -> { get :show, id: 5, session: 'secret_hash' }.should_not raise_error
            -> { get :show, id: 'ten', session: 'secret_hash' }.should_not raise_error
          end
        end
        ...
        context 'key validations are enabled' do
          ...
          it 'should fail if extra parameter is passed in' do
            -> { get :show, id: 5, session: 'secret_hash', badparam: 'badfoo' }.should raise_error(Apipie::UnknownParam, /\bbadparam\b/)
          end
        end
        ...
        context 'presence and value validations are enabled' do
          ...
          it 'should work with custom Type validator' do
            lambda do
              get :show,
                  id: 'not a number',
                  session: 'secret_hash'
            end.should raise_error(Apipie::ParamError, /id/) # old-style error rather than ParamInvalid
          end
          ...
          it 'should work with Regexp validator' do
            ...
            end.should raise_error(Apipie::ParamInvalid, /regexp_param/)
          end
          ...
          it 'should work with Array validator' do
            ...
            lambda do
              get :show,
                  ...
                  session: 'secret_hash',
                  array_param: 'blabla'
            end.should raise_error(Apipie::ParamInvalid, /array_param/)
          ...
          it 'should work with Proc validator' do
            lambda do
              get :show,
                  ...
                  session: 'secret_hash',
                  proc_param: 'asdgsag'
            end.should raise_error(Apipie::ParamInvalid, /proc_param/)
          ...
          it 'should work with Hash validator' do
            ...
            end.should raise_error(Apipie::ParamInvalid, /membership/)

            lambda do
              post :create, user: { name: 'root' }
            end.should raise_error(Apipie::ParamMissing, /pass/)

            lambda do
              post :create, user: 'a string is not a hash'
            end.should raise_error(Apipie::ParamInvalid, /user/)
  ...
  describe 'method description' do
    it 'should contain basic info about method' do
      ...
      b.formats.should eq(%w(json jsonp))
      api = b.apis.first
    ...
    context 'contain :see option' do
      ...
      context 'the key is not valid' do
        it 'should raise exception' do
          ...
          end.should raise_error(ArgumentError, /does not exist/)
      ...
      expected_hash = {
        ...
        params: [{ full_name: 'oauth',
                 ...
                 { validator: 'Must be a Hash',
                   ...
                   show: false,
                   params:                       [{ validator: 'Must be a Hash',
