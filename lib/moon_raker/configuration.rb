module MoonRaker
  class Configuration
    ...
    # it's MoonRaker::RoutesFormatter. To customize the behaviour, one can inherit from
    ...
    def cache_dir
      @cache_dir ||= File.join(Rails.root, 'public', 'moon_raker-cache')
    end
    ...
    def initialize
      @markup = MoonRaker::Markup::RDoc.new
