...
require 'moon_raker/client/base'
...
module MoonRaker
  module Client
    class Generator < Thor::Group
      ...
      def initialize(*args)
        super
        @doc = MoonRaker.to_json(version)[:docs]
      end
      ...
      def generate_cli
        ...
        create_file "lib/#{full_name}/documentation.json", JSON.dump(MoonRaker.to_json)
      ...
      def validation(method)
        ...
        MoonRaker::Client::Base.construct_validation_hash(stringify[method])
      end
    end
  end
end
